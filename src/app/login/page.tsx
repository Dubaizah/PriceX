          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                {t('auth.signInDesc', 'Sign in to access your saved products and alerts')}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isLoading ? t('auth.signingIn', 'Signing in...') : t('auth.login', 'Sign In')}
            ...
            <div className="mt-8 pt-6 border-t border-border">
              ...
              <div className="flex gap-4">
                <button className="flex-1 h-12 bg-secondary border border-border rounded-xl flex items-center justify-center gap-2 hover:bg-secondary/80 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.08-1.57c2.92 3.28-4.74 3.28-8.09z"/>
